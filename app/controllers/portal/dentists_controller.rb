...
class Portal::DentistsController < ApplicationController
  ...
  def index
    ...
    @sticking = [{title: '①	車が停めやすい広々駐車場', img: 'sticking1',
        text: "最大駐車数20台。\n 広い駐車スペースで安心した通院を実現。"},
      {title: '②	徹底した衛生管理', img: 'sticking2',
        text: '清潔な院内環境作りと最高レベルの滅菌機器で、徹底した衛生管理に勤めています。'},
      {title: '③	検査結果のお渡し', img: 'sticking3', text: '患者様自身でご自身の口腔状況を把握していただきやすいよう。検査結果を印刷してお渡ししております。'},
      {title: '④	将来を見越した治療', img: 'sticking4', text: "1, できる限り歯を削らない\n2, できる限り神経は抜かない\n3, できる限り抜歯しない\n当院では以上の事を心がけ将来を見越した治療を行なっています。"},
      {title: '⑤	訪問診療の実施', img: 'sticking5', text: 'お体が不自由な方や、お子様の為当院では訪問診療も実施しております。'},
